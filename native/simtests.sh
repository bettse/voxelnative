...
SCENES=(
  ...
  headroom "headroomTest:headroomtest"
)
...
order=(fall bounce place eat bow dig drop award station status step torch fly invpick reconnect chord weather bugnote ladder headroom ice igloo sneak)
